...
//go:generate swagger generate server --target ../../generate --name Relish --spec ../../swagger/swagger.yml

func configureFlags(api *operations.RelishAPI) {
	// api.CommandLineOptionsGroups = []swag.CommandLineOptionsGroup{ ... }
}

func configureAPI(api *operations.RelishAPI) http.Handler {
